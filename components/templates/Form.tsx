...
const Form = ({setAddress,setCity,setNote,setPhone} : formProps) => {
  return (
    <Fieldset className="space-y-8">
      ...
      <Field>
        <Label className="block pl-5">Phone Number</Label>
        <Input className="mt-1 block border border-dashed border-[#274C77] w-[90%] rounded-lg mx-auto" name="address" onChange={(e)=>setPhone(e.target.value)}/>
      </Field>
      <Field>
